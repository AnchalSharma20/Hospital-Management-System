...
<body>
	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6">
				<img alt="" height="500px" width="500px" src="https://media.istockphoto.com/id/176796285/photo/smiling-female-doctor.jpg?s=612x612&w=0&k=20&c=Ml-QmWAinZPjVqo6-9DY8st1zBHpwhynr8IM3XifEKE=">
			</div>
				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<c:if test="${not empty succMsg}">
							<p class=" fs-6 text-center text-success">${succMsg}</p>
